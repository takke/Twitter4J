...
final class ImgLyImageUpload {
    /**
     * Usage: java twitter4a.examples.media.ImgLyImageUpload [image file path] [message]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.media.ImgLyImageUpload [image file path] [message]");
            System.exit(-1);
        }
        try {
