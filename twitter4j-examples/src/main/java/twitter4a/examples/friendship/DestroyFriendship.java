...
public final class DestroyFriendship {
    /**
     * Usage: java twitter4a.examples.friendship.DestroyFriendship [screen name]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.friendship.DestroyFriendship [screen name]");
            System.exit(-1);
        }
        try {
