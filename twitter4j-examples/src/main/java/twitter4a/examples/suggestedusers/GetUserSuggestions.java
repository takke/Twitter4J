...
public final class GetUserSuggestions {
    /**
     * Usage: java twitter4a.examples.suggestedusers.GetUserSuggestions [slug]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.suggestedusers.GetUserSuggestions [slug]");
            System.exit(-1);
        }
