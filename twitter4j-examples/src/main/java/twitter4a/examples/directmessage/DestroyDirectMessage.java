...
public final class DestroyDirectMessage {
    /**
     * Usage: java twitter4a.examples.directmessages.DestroyDirectMessage [message id]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.directmessages.DestroyDirectMessage [message id]");
            System.exit(-1);
        }
        try {
