...
public final class GetUserListMemberships {
    /**
     * Usage: java twitter4a.examples.list.GetUserListMemberships [list member screen name]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.list.GetUserListMemberships [list member screen name]");
            System.exit(-1);
        }
        try {
