...
public final class DeleteUserListMember {
    /**
     * Usage: java twitter4a.examples.list.DeleteUserListMember [list id] [user id]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 2) {
            System.out.println("Usage: java twitter4a.examples.list.DeleteUserListMember [list id] [user id]");
            System.exit(-1);
        }
        try {
