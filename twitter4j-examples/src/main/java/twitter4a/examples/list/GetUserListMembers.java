...
public final class GetUserListMembers {
    /**
     * Usage: java twitter4a.examples.list.GetUserListMembers [list owner screen name] [list id]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.list.GetUserListMembers [list id]");
            System.exit(-1);
        }
        try {
