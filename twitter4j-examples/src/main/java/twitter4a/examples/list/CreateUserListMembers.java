...
public final class CreateUserListMembers {
    /**
     * Usage: java twitter4a.examples.list.CreateUserListMembers [list id] [screen name[,screen name..]]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 2) {
            System.out.println("Usage: java twitter4a.examples.list.CreateUserListMembers [list id] [screen name[,screen name..]]");
            System.exit(-1);
        }
        try {
