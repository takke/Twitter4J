...
public final class GetUserListSubscriptions {
    /**
     * Usage: java twitter4a.examples.list.GetUserListSubscriptions [screen name]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.list.GetUserListSubscriptions [screen name]");
            System.exit(-1);
        }
        try {
