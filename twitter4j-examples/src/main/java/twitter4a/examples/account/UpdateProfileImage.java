...
public final class UpdateProfileImage {
    /**
     * Usage: java twitter4a.examples.account.UpdateProfileImage [image file path]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.account.UpdateProfileImage [image file path]");
            System.exit(-1);
        }
        try {
