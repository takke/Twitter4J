 ...
 * Usage: java twitter4a.examples.stream.PrintSiteStreams [follow(comma separated numerical user ids)]<br>
 * </p>
 *
...
public final class PrintSiteStreams {
    ...
    public static void main(String[] args) throws TwitterException {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.PrintSiteStreams [follow(comma separated numerical user ids)]");
            System.exit(-1);
        }
