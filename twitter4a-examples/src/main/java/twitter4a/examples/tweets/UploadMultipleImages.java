...
public final class UploadMultipleImages {
    /**
     * Usage: java twitter4a.examples.tweets.UploadMultipleImages [text] [file1] [file2] ...
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.tweets.UploadMultipleImages [text] [file1] [file2] ...");
            System.exit(-1);
        }
        try {
