...
public final class DestroySavedSearch {
    /**
     * Usage: java twitter4a.examples.savedsearches.DestroySavedSearch [saved search id]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.savedsearches.DestroySavedSearch [saved search id]");
            System.exit(-1);
        }
        try {
