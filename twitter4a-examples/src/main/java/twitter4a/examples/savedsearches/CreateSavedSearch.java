...
public final class CreateSavedSearch {
    /**
     * Usage: java twitter4a.examples.savedsearches.CreateSavedSearch [query]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.savedsearches.CreateSavedSearch [query]");
            System.exit(-1);
        }
        try {
