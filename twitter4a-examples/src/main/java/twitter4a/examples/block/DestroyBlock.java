...
package twitter4a.examples.block;
...
public final class DestroyBlock {
    /**
     * Usage: java twitter4a.examples.block.DestroyBlock [screen name]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.block.DestroyBlock [screen name]");
            System.exit(-1);
        }
        try {
