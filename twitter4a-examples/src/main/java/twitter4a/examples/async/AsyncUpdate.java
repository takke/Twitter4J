 ...
 * Usage: java twitter4a.examples.AsyncUpdate <i>TwitterID</i> <i>TwitterPassword</i> <i>text</i><br>
 * </p>
 *
...
public final class AsyncUpdate {
    ...
    public static void main(String[] args) throws InterruptedException {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.AsyncUpdate text");
            System.exit(-1);
        }
