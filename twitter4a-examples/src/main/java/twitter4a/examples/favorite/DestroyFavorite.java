...
package twitter4a.examples.favorite;
...
public final class DestroyFavorite {
    /**
     * Usage: java twitter4a.examples.favorite.DestroyFavorite [status id]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.favorite.DestroyFavorite [status id]");
            System.exit(-1);
        }
        try {
