...
public final class CreateMessage {
    /**
     * Usage: java twitter4a.examples.directMessage.CreateMessage [recipient screen name] [message]
     *
     * @param args String[]
     */
    public static void main(String[] args) {
        if (args.length < 2) {
            System.out.println("Usage: java twitter4a.examples.directmessage.CreateMessage [recipient user id] [message]");
            System.exit(-1);
        }
