...
public final class DestroyDirectMessageEvent {
    /**
     * Usage: java twitter4a.examples.directmessages.DestroyDirectMessageEvent [message id]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.directmessages.DestroyDirectMessageEvent [message id]");
            System.exit(-1);
        }
        try {
