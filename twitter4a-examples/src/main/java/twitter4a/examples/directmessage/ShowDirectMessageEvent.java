...
public class ShowDirectMessageEvent {
    /**
     * Usage: java twitter4a.examples.directmessage.ShowDirectMessageEvent [message id]
     *
     * @param args String[]
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.directmessage.ShowDirectMessageEvent [message id]");
            System.exit(-1);
        }
