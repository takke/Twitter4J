...
public final class GetMemberSuggestions {
    /**
     * Usage: java twitter4a.examples.suggestedusers.GetMemberSuggestions [slug]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.suggestedusers.GetMemberSuggestions [slug]");
            System.exit(-1);
        }
