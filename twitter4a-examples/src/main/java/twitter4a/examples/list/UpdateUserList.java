...
public final class UpdateUserList {
    /**
     * Usage: java twitter4a.examples.list.UpdateUserList [list id] [new list name] [new description]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 3) {
            System.out.println("Usage: java twitter4a.examples.list.UpdateUserList [list id] [new list name] [new description]");
            System.exit(-1);
        }
        try {
