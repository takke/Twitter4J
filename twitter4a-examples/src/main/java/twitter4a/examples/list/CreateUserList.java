...
public final class CreateUserList {
    /**
     * Usage: java twitter4a.examples.list.CreateUserList [list name] [list description]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.list.CreateUserList [list name] [list description]");
            System.exit(-1);
        }
        try {
