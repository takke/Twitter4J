...
public final class ReverseGeoCode {
    /**
     * Usage: java twitter4a.examples.geo.ReverseGeoCode [latitude] [longitude]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 2) {
            System.out.println("Usage: java twitter4a.examples.geo.ReverseGeoCode [latitude] [longitude]");
            System.exit(-1);
        }
        try {
