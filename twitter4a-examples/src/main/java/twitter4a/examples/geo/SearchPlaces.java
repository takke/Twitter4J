...
public final class SearchPlaces {
    /**
     * Usage: java twitter4a.examples.geo.SearchPlaces [ip address] or [latitude] [longitude]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.geo.SearchPlaces [ip address] or [latitude] [longitude]");
            System.exit(-1);
        }
        try {
