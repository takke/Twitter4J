...
public final class GetSimilarPlaces {
    /**
     * Usage: java twitter4a.examples.geo.GetSimilarPlaces [latitude] [longitude] [place id]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 3) {
            System.out.println("Usage: java twitter4a.examples.geo.GetSimilarPlaces [latitude] [longitude] [name] [place id]");
            System.exit(-1);
        }
        try {
