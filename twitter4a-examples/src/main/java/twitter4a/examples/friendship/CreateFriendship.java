...
public final class CreateFriendship {
    /**
     * Usage: java twitter4a.examples.friendship.CreateFriendship [screen name]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: java twitter4a.examples.friendship.CreateFriendship [screen name]");
            System.exit(-1);
        }
        try {
