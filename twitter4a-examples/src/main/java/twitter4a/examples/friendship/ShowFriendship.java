...
public final class ShowFriendship {
    /**
     * Usage: java twitter4a.examples.friendship.ShowFriendship  [source screen name] [target screen name]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 2) {
            System.out.println("Usage: java twitter4a.examples.friendship.ShowFriendship [source screen name] [target screen name]");
            System.exit(-1);
        }
        try {
