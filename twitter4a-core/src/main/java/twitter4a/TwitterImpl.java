...
import twitter4a.api.DirectMessagesResources;
import twitter4a.api.FavoritesResources;
import twitter4a.api.FriendsFollowersResources;
import twitter4a.api.HelpResources;
import twitter4a.api.ListsResources;
import twitter4a.api.PlacesGeoResources;
import twitter4a.api.SavedSearchesResources;
import twitter4a.api.SearchResource;
import twitter4a.api.SpamReportingResource;
import twitter4a.api.SuggestedUsersResources;
import twitter4a.api.TimelinesResources;
import twitter4a.api.TrendsResources;
import twitter4a.api.TweetsResources;
import twitter4a.api.UsersResources;
import twitter4a.auth.Authorization;
import twitter4a.conf.ChunkedUploadConfiguration;
import twitter4a.conf.Configuration;

import static twitter4a.HttpParameter.getParameterArray;
...
class TwitterImpl extends TwitterBaseImpl implements Twitter {
    ...
    public int createMediaMetadata(long mediaId, String altText) throws TwitterException {
        try {
            JSONObject json = new JSONObject().put("media_id", ""+mediaId)
