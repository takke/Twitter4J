...
public interface TweetsResources {
     ...
     * @throws twitter4a.TwitterException when Twitter service or network is unavailable
    ...
    /**
     * Uploads media image to be attached via {@link #updateStatus(twitter4a.StatusUpdate)}
    ...
    /**
     * Uploads media using chunked approach to be attached via {@link #updateStatus(twitter4a.StatusUpdate)}.
