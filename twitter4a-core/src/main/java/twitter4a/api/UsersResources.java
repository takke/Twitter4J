...
public interface UsersResources {
     ...
     *
     * @return user
     * @throws twitter4a.TwitterException when Twitter service or network is unavailable, or if supplied credential is wrong (TwitterException.getStatusCode() == 401)
